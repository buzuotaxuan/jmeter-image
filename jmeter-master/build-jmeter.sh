...
wget https://hub.fastgit.org/liuruibin/generate-report/releases/download/v0.0.9/generate-report-0.0.9.jar && \
...
mv generate-report-0.0.9.jar /jmeter-log/generate-report.jar && \
