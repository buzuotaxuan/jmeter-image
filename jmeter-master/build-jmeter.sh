...
wget https://hub.fastgit.org/metersphere/generate-report-release/releases/download/v0.3.0/generate-report-0.3.0.jar && \
...
mv generate-report-0.3.0.jar /jmeter-log/generate-report.jar && \
