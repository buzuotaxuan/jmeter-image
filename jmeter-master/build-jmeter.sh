JMETER_VERSION="5.4.3" &&
  ...
  DUBBO_JMETER_PLUGIN_VERSION="2.7.13" &&
  SCRIPT_DIR=$(
  ...
  wget -N --no-check-certificate https://hub.fastgit.org/metersphere/generate-report-release/releases/download/v0.3.5/generate-report-0.3.5.jar &&
