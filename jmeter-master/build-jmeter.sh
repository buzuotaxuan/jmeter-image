...
wget https://hub.fastgit.org/liuruibin/generate-report/releases/download/v0.1.2/generate-report-0.1.2.jar && \
...
mv generate-report-0.1.2.jar /jmeter-log/generate-report.jar && \
