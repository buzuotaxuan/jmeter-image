...
wget https://hub.fastgit.org/metersphere/generate-report-release/releases/download/v0.2.9/generate-report-0.2.9.jar && \
...
mv generate-report-0.2.9.jar /jmeter-log/generate-report.jar && \
