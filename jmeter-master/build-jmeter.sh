...
wget https://hub.fastgit.org/metersphere/generate-report-release/releases/download/v0.2.8/generate-report-0.2.8.jar && \
...
mv generate-report-0.2.8.jar /jmeter-log/generate-report.jar && \
