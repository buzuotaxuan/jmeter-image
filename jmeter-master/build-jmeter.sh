...
wget https://hub.fastgit.org/liuruibin/generate-report/releases/download/v0.2.0/generate-report-0.2.0.jar && \
...
mv generate-report-0.2.0.jar /jmeter-log/generate-report.jar && \
