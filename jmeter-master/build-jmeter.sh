...
wget https://hub.fastgit.org/metersphere/generate-report/releases/download/v0.2.3/generate-report-0.2.3.jar && \
...
mv generate-report-0.2.3.jar /jmeter-log/generate-report.jar && \
